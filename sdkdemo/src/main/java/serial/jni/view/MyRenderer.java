...
public class MyRenderer implements Renderer {
    ...
    private int displayMode = DrawUtils.getDisplayMode();  //显示布局方式
    ...
    private short[] temp = new short[72];     //72个数据
    ...
    public void onDrawFrame(GL10 gl) {
        if (GLView.isGather) {
            ...
            Log.e(TAG, "渲染 mode : " + this.displayMode);
            switch (this.displayMode) {
                case 0://12*1仅12导有效
                    if (this.IsDrawFont.booleanValue() || this.IsClearScreen) {
                        ...
                        this.CX = -8.6F;
                        //绘制左侧刻度文字
                        this.DrawFont(gl, DrawUtils.vertex_1, this.leadString[0], 0);//刻度1
                        this.DrawFont(gl, DrawUtils.vertex_2, this.leadString[1], 1);//刻度2
                        this.DrawFont(gl, DrawUtils.vertex_3, this.leadString[2], 2);//刻度3
                        this.DrawFont(gl, DrawUtils.vertex_aVR, this.leadString[3], 3);//刻度4
                        this.DrawFont(gl, DrawUtils.vertex_aVL, this.leadString[4], 4);//刻度5
                        this.DrawFont(gl, DrawUtils.vertex_aVF, this.leadString[5], 5);//刻度6
                        this.DrawFont(gl, DrawUtils.vertex_V1, this.leadString[6], 6);//刻度7
                        this.DrawFont(gl, DrawUtils.vertex_V2, this.leadString[7], 7);//刻度8
                        this.DrawFont(gl, DrawUtils.vertex_V3, this.leadString[8], 8);//刻度9
                        this.DrawFont(gl, DrawUtils.vertex_V4, this.leadString[9], 9);//刻度10
                        this.DrawFont(gl, DrawUtils.vertex_V5, this.leadString[10], 10);//刻度11
                        this.DrawFont(gl, DrawUtils.vertex_V6, this.leadString[11], 11);//刻度12
