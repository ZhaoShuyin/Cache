...
public class GLActivity2 extends Activity {
    ...
    private serial.jni.view.GLView glView;
        ...
        b6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (q % 4 == 0) {
                    ...
                    Toast.makeText(mContext, "12x1显示，仅12导有效！模式1", Toast.LENGTH_LONG).show();
                } else if (q % 4 == 1) {
                    data.setDisplayMode(DataUtils.DISPLAY_MODE_6x2);
                    Toast.makeText(mContext, "6x2显示，仅12导有效！模式2", Toast.LENGTH_LONG).show();
                } else if (q % 4 == 2) {
                    data.setDisplayMode(DataUtils.DISPLAY_MODE_2x6_LIMB);//四肢
                    Toast.makeText(mContext, "6导（肢体导联）显示 模式3", Toast.LENGTH_LONG).show();
                } else if (q % 4 == 3) {
                    data.setDisplayMode(DataUtils.DISPLAY_MODE_2x6_CHEST);//胸部
                    Toast.makeText(mContext, "6导（胸导导联）显示模式4", Toast.LENGTH_LONG).show();
                }
                q++;
            }
        });
...
*/
        ...
        glView = (serial.jni.view.GLView) this.findViewById(R.id.GLWave2);
...
//                intent.setClass(mContext, UsbDeviceListActivity.class);
    ...
    public static final int MESSAGE_CONNECT_FAILED = 0x300;  //768
    public static final int MESSAGE_CONNECT_INTERRUPTED = 0x400;//1024

    public static final int MESSAGE_USB_CONNECT_START = 0xA010;//40976
    public static final int MESSAGE_USB_CONNECT_SUCCESS = 0xA020;//40992
    public static final int MESSAGE_USB_CONNECT_FAILED = 0xA030;//41008
    public static final int MESSAGE_USB_CONNECT_INTERRUPTED = 0xA040;//41024
    public static final int MESSAGE_USB_CONNECT_NO_USB_PERMISSION = 0xA050;//41040
    public static final int MESSAGE_USB_CONNECT_ERROR_SETTING_DEVICE = 0xA060;//41056
    public static final int MESSAGE_USB_CONNECT_REMOVE_DEVICE = 0xA070;//41072
    public static final int MESSAGE_USB_CONNECT_ERROR_OPEN_DEVICE = 0xD050;//53328
    //连接回调 handler
...
//				Log.e("BL", "INT");
                ...
                case MESSAGE_USB_CONNECT_FAILED:
                    ...
                    Intent mintent = new Intent(GLActivity2.this,
                            DeviceListActivity.class);
...
//                Log.e("ecgdata", " 数据 " + mEcgQueue.size());
    ...
    static void show(Context context, UsbDevice usbDevice, UsbManager usbManager) {
        ...
        final Intent intent = new Intent(context, GLActivity2.class);
