...
public class ThreadPoolProxy {
    ...
    ThreadPoolExecutor mExecutor;  //线程池创建器
    private int mCorePoolSize;     //线程核心数量
    private int mMaximumPoolSize;  //线程最大数量
    ...
    private void initThreadPoolExecutor() {
        if (mExecutor == null              //
                || mExecutor.isShutdown()  //关闭
                || mExecutor.isTerminated()//终止
                ) {
